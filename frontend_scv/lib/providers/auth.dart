...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    try {
      ...
      _autoLogout();
      notifyListeners();
      //Setting up shared_preferences (local storage)
      final prefs = await SharedPreferences.getInstance();
      // if  we want we can use a json map as a string(JSON is wrapped in a
      // string)
      ...
      //Remember that this is where we catch errors like no internet
      // connection  etc. the firebase errors (like incorrect password) will
      // not be caught here - they still reply... thus we need to check the
      // response status code and  go from there
      throw error;
    }
  }
  ...
  Future<void> signup(String email, String password) async {
    ...
    //without the return it wouldn't wait
  }
