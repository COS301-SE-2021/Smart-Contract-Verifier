...
$ curl 'http://localhost:8080/user/0x743Fb032c0bE976e1178d8157f911a9e825d9E23/contactList/310deb0e-e828-44c9-b9c0-ca35b4142913' -i -X PUT \
    ...
    -H 'Authorization: bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIweDc0M0ZiMDMyYzBiRTk3NmUxMTc4ZDgxNTdmOTExYTllODI1ZDlFMjMiLCJleHAiOjE2MzMyMTAyNjd9.5ayEIn-z_I1By9zQ5-mwW-m1gT0S7cgcl0BBo--Ifw8' \
    -d '{
