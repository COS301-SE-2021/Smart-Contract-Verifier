...
class GetAllEvidenceDatabaseTest {
    ...
    fun beforeEach()
    {
        ...
        uEvidence = Evidence(UUID.fromString("c6671a40-6002-4338-ad2d-a26b51507949"),
            "uploadedEvidenceHash",
            EvidenceType.UPLOADED)
        uEvidence.user = userA
        uEvidence.contract = agreement
    ...
    @Test
    fun `get all evidence database test`(){
        //given

        //when
        val response = evidenceService.getAllEvidence(userA.publicWalletID, agreement.ContractID)
