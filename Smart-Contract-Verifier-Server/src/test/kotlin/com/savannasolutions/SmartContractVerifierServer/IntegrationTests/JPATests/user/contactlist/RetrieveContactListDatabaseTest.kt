...
class RetrieveContactListDatabaseTest {
    @Autowired
    ...
    fun beforeEach()
    {
        ...
        contactListProfile = ContactListProfile(
            UUID.fromString("7bd871eb-a9a3-4409-914c-2a184dd5d89e"),
    ...
    {
        val request = RetrieveContactListRequest(testContactList.contactListID!!)

        val response = contactListService.retrieveContactList(request)
