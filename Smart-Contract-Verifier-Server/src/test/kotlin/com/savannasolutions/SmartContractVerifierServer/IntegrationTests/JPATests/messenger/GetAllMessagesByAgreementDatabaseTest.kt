...
class GetAllMessagesByAgreementDatabaseTest {
    ...
    fun beforeEach()
    {
        ...
        messageA = Messages(UUID.fromString("e47456d6-4f19-4fba-af22-e80e89d715bd"),
                            "Message A",
                            Date()).apply { sender = userA }.apply { agreements = agreement }
        ...
        messageB = Messages(UUID.fromString("548aa4a6-0287-4d34-88e1-9ae08b8a9d0a"),
                            "Message B",
                            Date()).apply { sender = userA }.apply { agreements = agreement }
