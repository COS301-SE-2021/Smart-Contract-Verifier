...
internal class GetAllEvidenceUnitTest {
                                            ...
                                            fileURL: String): ApiResponse<GetAllEvidenceResponse>
    {
        ...
        whenever(evidenceRepository.existsById(uploadedEvidence!!.evidenceHash)).thenReturn(true)
        whenever(evidenceRepository.getById(uploadedEvidence!!.evidenceHash)).thenReturn(uploadedEvidence)
        whenever(evidenceRepository.existsById(linkedEvidence!!.evidenceHash)).thenReturn(true)
