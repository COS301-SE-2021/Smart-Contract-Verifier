...
create table agreements (contractid uuid not null, agreement_description varchar(255), agreement_imageurl varchar(255), agreement_title varchar(255), created_date timestamp, duration_conditionuuid uuid, moved_to_block_chain boolean not null, payment_conditionuuid uuid, sealed_date timestamp, blockchainid int, primary key (contractid));
