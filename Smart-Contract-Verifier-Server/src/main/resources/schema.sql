...
create table evidence (evidence_id uuid not null, evidence_hash varchar(255), evidence_type bytea, removed boolean not null, contract_contractid uuid, user_public_walletid varchar(255), primary key (evidence_id));
...
create table linked_evidence (evidenceid uuid not null, evidence_url varchar(255), evidence_evidence_id uuid, primary key (evidenceid));
...
create table uploaded_evidence (evidenceid uuid not null, file_mime_type varchar(255), filename varchar(255), original_filename varchar(255), evidence_evidence_id uuid, primary key (evidenceid));
...
alter table linked_evidence add constraint FKto24gl79ioee2qgcy5cgvnia4 foreign key (evidence_evidence_id) references evidence;
...
alter table uploaded_evidence add constraint FK60fjie75bdigtlj2bd5kf1h9s foreign key (evidence_evidence_id) references evidence;
