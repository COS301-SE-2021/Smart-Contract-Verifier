...
create table public.user (public_walletid varchar(255) not null, alias varchar(255), primary key (public_walletid));
...
drop table if exists contact_list_profile;
...
drop table if exists uploaded_evidence;
